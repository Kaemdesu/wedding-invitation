...
export function Footer() {
  return (
    <footer className="relative left-1/2 right-1/2 -mx-[50vw] w-screen overflow-hidden">
      {/* Smooth transition INTO the photo — matches the ring scene → bismillah transition */}
      <div
        aria-hidden
      ...
      <div className="relative -mt-48 flex min-h-screen items-center justify-center">
