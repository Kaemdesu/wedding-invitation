...
export function Footer() {
  return (
    <footer className="relative left-1/2 right-1/2 -mx-[50vw] flex min-h-screen w-screen items-center justify-center overflow-hidden">
      ...
      {/* Top fade — smooth blend from page background into the photo */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 top-0 h-64 bg-gradient-to-b from-background via-background/70 to-transparent md:h-80"
      />

      {/* Bottom fade */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-background/80 to-transparent md:h-48"
      />
      ...
      {/* Centered content */}
      <div className="relative z-10 flex w-full items-center justify-center px-6 safe-x safe-top safe-bottom">
        <motion.div
